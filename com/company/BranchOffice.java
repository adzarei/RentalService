...
public class BranchOffice {
	...
	public BranchOffice(String address, int id) {
	...
	public Reservation getReturnReservation(String identifier_Reservation){
		return colboRReturn.get(identifier_Reservation);
	}
	...
	public Reservation getPickupReservation(String identifier_Reservation){
		return colboRPickup.get(identifier_Reservation);
	}
